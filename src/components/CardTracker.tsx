  ...
  return (
    <section className="tracker-panel flex min-h-0 flex-1 flex-col px-1 pt-1 md:rounded-[2rem] md:bg-[var(--surface)] md:p-4 md:shadow-soft">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto pb-20 pr-1">
        {cards.length === 0 ? (
          <div className="flex min-h-56 flex-col items-center justify-center rounded-[1.6rem] border border-dashed border-[var(--border)] bg-[var(--surface)] p-6 text-center">
            <p className="text-lg font-black">No cards yet</p>
            <p className="mt-2 max-w-64 text-sm font-semibold text-[var(--text-muted)]">Add creatures, commanders, or permanents whose stats keep shifting during the game.</p>
          </div>
        ) : (
