import type { SettingsState, TrackedCardState } from "../types";
  ...
  return (
    <section className="game-shell min-h-0 flex-1 md:grid md:grid-cols-[minmax(22rem,0.85fr)_1.15fr] md:gap-5">
      <LifeCounter
        ...
        onChangeLife={props.onChangeLife}
        onReset={props.onResetLife}
        onStartingLifeChange={props.onStartingLifeChange}
      />
      <CardTracker
        cards={props.cards}
        onAddCard={props.onAddCard}
        onUpdateCard={props.onUpdateCard}
        onResetCard={props.onResetCard}
